...
function Custom({navigate,cart,setCart}) {
  ...
  const Pill=({label,sel,onClick})=><button type="button" tabIndex={-1} onClick={onClick} style={{fontFamily:'var(--fm)',fontSize:'10px',letterSpacing:'1px',textTransform:'uppercase',padding:'7px 14px',borderRadius:'4px',border:sel?'1px solid var(--adim)':'1px solid rgba(255,255,255,.1)',background:sel?'rgba(255,255,255,.07)':'rgba(255,255,255,.025)',color:sel?'var(--accent)':'var(--tdim)',transition:'all .2s',cursor:'pointer'}}>{label}</button>;
  const Swatch=({opt,sel,onClick})=><button type="button" tabIndex={-1} onClick={onClick} style={{display:'flex',alignItems:'center',gap:'9px',fontFamily:'var(--fm)',fontSize:'10px',letterSpacing:'1px',textTransform:'uppercase',padding:'8px 12px',borderRadius:'4px',border:sel?'1px solid var(--adim)':'1px solid rgba(255,255,255,.1)',background:sel?'rgba(255,255,255,.07)':'rgba(255,255,255,.025)',color:sel?'var(--accent)':'var(--tdim)',transition:'all .2s',cursor:'pointer'}}><div style={{width:'16px',height:'16px',borderRadius:'50%',flexShrink:0,background:opt.hex||'transparent',border:opt.hex?'1px solid rgba(255,255,255,.15)':'1px dashed rgba(255,255,255,.3)',boxShadow:opt.hex?`0 0 6px ${opt.hex}33`:'none',display:'flex',alignItems:'center',justifyContent:'center'}}>{!opt.hex&&<span style={{fontSize:'8px',color:'var(--tdim)'}}>✕</span>}</div>{opt.name}</button>;
